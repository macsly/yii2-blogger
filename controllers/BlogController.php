...
namespace macsly\blogger\controllers;


use common\models\ImageManager;
use Yii;
use macsly\blogger\models\BlogSearch;
...
class BlogController extends Controller
{
    ...
    {
        $model = new \macsly\blogger\models\Blog();
        $model->sort = 50;
    ...
    {
        if (($model = \macsly\blogger\models\Blog::find()->with('tags')->andWhere(['id'=>$id])->one()) !== null) {
            return $model;
        } else {
